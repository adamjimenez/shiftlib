...
class TelTest extends TestCase
{
    ...
    {
        $component = new \cms\components\Tel($this->cms, $this->auth, $this->vars);
        $this->assertTrue($component->isValid(0116254323434));
        $this->assertFalse($component->isValid('sdsadsad'));
    }
}
